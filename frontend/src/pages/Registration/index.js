    ...
    <div class="container">
      ...
      <form class="mt-3">
            ...
            <fieldset class="row gx-3">
              ...
              <div class="form-floating mb-3 col-md-6 col-xl-4">
                ...
                <label
                  ...
                  class="d-inline d-sm-none d-md-inline d-lg-none"
                >
                  Data Nascimento
                </label>
                <label
                  for="txtDataNascimento"
                  class="d-none d-sm-inline d-md-none d-lg-inline"
                >
                  Data de Nascimento
                </label>
              </div>
            ...
            <fieldset class="row gx-3">
              ...
              <div class="form-floating mb-3 col-lg-6">
                <input
                  ...
                  placeholder=" "
                />
                <label class="form-label" for="txtConfirmacaoSenha">
        ...
        <div class="mb-3 text-left">
          <a class="btn btn-lg btn-light btn-outline-danger" href="/">
            Cancelar
          </a>
          <input
            type="button"
