  ...
  <main className="flex-fill">
    <div className="container">
      ...
      <p>
        ...
        Ao acessar ao site <a href="http://www.dominio.com">Quitanda Online</a>,
      ...
      <p>
        ...
        materiais (informações ou software) no site Quitanda Online , apenas
      ...
      <ol>
        ...
        <li>
          ...
          contido no site Quitanda Online;
        </li>
        <li>
      ...
      <p>
        ...
        dessas restrições e poderá ser rescindida por Quitanda Online a qualquer
      ...
      <ol>
        <li>
          Os materiais no site da Quitanda Online são fornecidos 'como estão'.
          Quitanda Online não oferece garantias, expressas ou implícitas, e, por
        ...
        <li>
          Além disso, o Quitanda Online não garante ou faz qualquer
      ...
      <h2>4. Limitações</h2>
      <p>
        Em nenhum caso o Quitanda Online ou seus fornecedores serão responsáveis
        ...
        ou da incapacidade de usar os materiais em Quitanda Online, mesmo que
        Quitanda Online ou um representante autorizado da Quitanda Online tenha
      ...
      <p>
        Os materiais exibidos no site da Quitanda Online podem incluir erros
        técnicos, tipográficos ou fotográficos. Quitanda Online não garante que
        qualquer material em seu site seja preciso, completo ou atual. Quitanda
        Online pode fazer alterações nos materiais contidos em seu site a
        qualquer momento, sem aviso prévio. No entanto, Quitanda Online não se
        compromete a atualizar os materiais.
      </p>
      <h2>6. Links</h2>
      <p>
        O Quitanda Online não analisou todos os sites vinculados ao seu site e
        não é responsável pelo conteúdo de nenhum site vinculado. A inclusão de
        qualquer link não implica endosso por Quitanda Online do site. O uso de
        qualquer site vinculado é por conta e risco do usuário.
      </p>

      <h3>Modificações</h3>
      <p>
        O Quitanda Online pode revisar estes termos de serviço do site a
      ...
      <p>
        ...
        leis do Quitanda Online e você se submete irrevogavelmente à jurisdição
